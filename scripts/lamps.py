...
class DiagnosticsLamps():
    ...
    def publish_diagnostics(self):
        ...
        message.lamp_driver_states.lamp_driver_1 = Bool(self.lamp_drivers["1"]["value"])
        message.lamp_driver_states.lamp_driver_2 = Bool(self.lamp_drivers["2"]["value"])
        message.lamp_driver_states.lamp_driver_3 = Bool(self.lamp_drivers["3"]["value"])
        message.lamp_driver_states.lamp_driver_4 = Bool(self.lamp_drivers["4"]["value"])
